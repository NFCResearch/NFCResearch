...
class blk(gr.basic_block):  # other base classes are basic_block, decim_block, interp_block
    ...
    def __init__(self, tx_fs=12.5e6, ask_percent=1.0, commandCode=0b00000001, maskLength=0b00000000):  # only default arguments here
        ...
        self.message_port_register_out(pmt.intern("tx_len"))
    ...
    def work(self, input_items, output_items):
        ...
        if not self.data_generated:
            ...
            self.message_port_pub(pmt.intern("tx_len"), pmt.from_long(self.command_data_len))
    ...
    #Get flagBits from generate command data block
